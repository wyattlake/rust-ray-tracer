...
impl Material {
    ...
    //Sets a material
    pub fn set(&mut self, color: Color, ambient: f32, diffuse: f32, specular: f32, shininess: f32) {
        self.color = color;
...
impl Clone for Material {
    fn clone(&self) -> Material {
        Material::new(self.color.clone(), self.ambient.clone(), self.diffuse.clone(), self.specular.clone(), self.shininess.clone())
    }
}